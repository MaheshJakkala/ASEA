...
class AuthControllerTest {
    ...
    void testLogin() throws Exception {
        ...
        AuthResponse res = new AuthResponse("mock-jwt-token");

        when(authService.authenticateUser(any(AuthRequest.class))).thenReturn(res);
    ...
    void testRegister() throws Exception {
        RegisterRequest req = new RegisterRequest("user", "user@email.com", "password");
